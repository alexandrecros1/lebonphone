    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="well well-sm">
                <form action="../admin/adminaddtelephone.php" method="POST">
                    <fieldset>
                        <legend class="text-center">Mettre un téléphone en vente</legend>
                        <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select type="text" name='iduser' class="form-control" required>
                                    <option value=0>Choisir parmi les propositions...</option>
                                    <?php
                                    $req = getDatabase()->prepare('SELECT * FROM utilisateur');
                                    $req->execute();
                                    $row = $req->fetch();
                                    while ($row) {
                                        $iduser = $row["iduser"];
                                        $nom = $row["nom"];
                                        $prenom = $row["prenom"];
                                        echo "<option value='$iduser'>$nom $prenom</option>";
                                        $row = $req->fetch();
                                    }
                                    ?>
                                </select>
